...
<html>
  ...
  <body>
    <h1 class="title">FairComp Job Level Filter Page</h1>
    <hr class="headerLineBreak" />


   <div class = "filterStateInput"> 
   		<form action="" method="get">
   			<input type="text" class="form-control" name="q" placeholder="Enter Job Position Abbreviation (i.e. L1, L2, L3)..."/>
   		</form>
   </div>
   ...
   <div class = "filterLocation"> 
    <% 
      ...
      try {   
          ...
          if(query!=null)
          {
        	  data = "SELECT company_name, job_name, job_level, location, CompanyCompensation.base_salary, sign_on_bonus, annual_bonus, other_pay FROM CompanyCompensation, CompanyInfo, JobPositionCompensation WHERE CompanyCompensation.CompanyID = CompanyInfo.CompanyID AND job_level = '"+query+"'";
